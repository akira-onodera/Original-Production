...
public class TeamNewsContributeAction extends ActionSupport implements SessionAware{
	...
	public String execute(){
		String ret = SUCCESS;
		String team = session.get("team_name").toString();

		NewsDAO ndao = new NewsDAO();
		ndao.contribute(templateImgPass, team, title, comment);
