...
<body>
	...
	<div id="main">
		...
		<br />
		<div class="content">
			<input class="js-modal-open" id="btn-black" type="submit" value="投稿"
				data-target="CONTRIBUTE" /> <input class="js-modal-open"
				id="btn-black" type="submit" value="修正" data-target="UPDATE" /> <input
		...
		<div id="CONTRIBUTE" class="modal js-modal">
			...
			<div class="modal__content">
				<div class="cp_form">
					<s:form action="NewsContributeAction" class="cp_group">
						<div class="title">
							<h2>チームニュース 投稿</h2>
						</div>
						<div class="cp_tx">
		...
		<div id="UPDATE" class="modal js-modal">
			...
			<div class="modal__content">
				...
				<div class="cp_form">
					<s:form action="NewsUpdateAction" class="cp_group">
						<div class="title">
							<h2>チームニュース 投稿</h2>
						</div>
						<div class="cp_tx">
		...
		<div id="DELETE" class="modal js-modal">
			<div class="modal__bg js-modal-close"></div>
			<div class="modal__content">
				<s:form action="NewsDeleteAction">
					<table class="list">
						<tbody>
							<tr>
								<th>*</th>
								...
								<s:iterator value="newsList">
									<tr>
										<td><input type="checkbox" name="checkList"
											class="checkBoxList" value="<s:property value='id'/>"
											onchange="changeAttribute()" /></td>
										<td><s:property value="title" /></td>
